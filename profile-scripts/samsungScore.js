var samsungScoreCo = {
	...
	logisticEq = function(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
		return 1 / (1 + Math.exp(-(b.b0 + b.b1 * c + b.b2 * d + b.b3 * e + b.b4 * f + b.b5 * g + b.b6 * h + b.b7 * i + b.b8 * j + b.b9 * k + b.b10 * l + b.b11 * m + b.b12 * n + b.b13 * o + b.b14 * p)))
	};
